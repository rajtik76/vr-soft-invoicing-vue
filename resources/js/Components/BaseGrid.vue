...
export interface Props {
  gridUrl: string,
  gridUrlCustomPostData?: object | null,
...
const perPageOptions: Record<string, string> = {
  '10': '10',
  '20': '20',
  '50': '50',
}
...
function getPostData(): PostData {
  ...
  if (props.gridUrlCustomPostData !== null) {
    // merge custom post data
    return Object.assign(postData, props.gridUrlCustomPostData)
  }
